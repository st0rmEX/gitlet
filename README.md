# Git-Lite
A lite-version of the widely used version-control system Git written in Java. In this implementation, Git-Lite uses tree like data structures to store "blobs" of 
